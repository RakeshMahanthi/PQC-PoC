...
- Add a sample hybrid certificate generation script for a specific OpenSSL+liboqs build (if you want, I can add one tailored to your OpenSSL provider).
- Add automated tests verifying a TLS connection negotiates a hybrid PQC key exchange (depends on client tooling).
- Add a small Makefile or script to build the Docker image, generate certs, and run tests.
